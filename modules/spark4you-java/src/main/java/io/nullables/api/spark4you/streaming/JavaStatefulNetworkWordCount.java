...
public class JavaStatefulNetworkWordCount {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JavaPairRDD<String, Integer> initialRDD = ssc.sparkContext().<String, Integer>parallelizePairs(tuples);
        ...
        // DStream made of get cumulative counts that get updated in every
        // batch
